      ...
      <a
        className={cn(
          isActive
            ...
            : "outline-none hover:bg-gray-200/50 focus:bg-gray-200/50 focus:ring-1 focus:ring-gray-200 hover:dark:bg-gray-800 focus:dark:bg-gray-800",
          " hidden flex-1 rounded-lg p-1 text-left transition-all sm:px-3 sm:py-2 md:inline-block"
        )}
      >
        <span className="capsize">{text}</span>
      </a>
...
const MoreMenu = ({ text, items }: any) => (
  <button
    className={`header-menu relative
        hidden cursor-pointer flex-nowrap rounded-lg p-1 outline-none transition-all hover:bg-gray-200/50 focus:bg-gray-200/50 focus:ring-1 focus:ring-gray-200 hover:dark:bg-gray-800 focus:dark:bg-gray-800 sm:px-3 sm:py-2 md:inline-block
      `}
  >
    ...
    <div className="header-more-menu absolute left-0 mt-2 flex flex-col rounded bg-white py-4 px-1  shadow dark:bg-gray-800">
      {items.map((item: any) => (
        <NavItem {...item} key={`item-${item.text}`} />
      ))}
    </div>
  </button>
);
...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-col justify-center bg-white/30 text-sm shadow-sm backdrop-blur-md dark:border-b-2 dark:border-gray-800 dark:bg-black/60 print:hidden">
