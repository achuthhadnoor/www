const Social = () => (
  <div className="flex:1 align-items:center  mx-5  flex w-full justify-center space-x-5 md:w-auto md:justify-start">
    <a
      rel="noreferrer"
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          className="fill-[#ff95ba] dark:fill-[#9b0101]"
          d="M16 12.5c0 4.142-2.502 4-6.645 4-4.142 0-8.355.142-8.355-4S6.858 6 11 6s5 2.358 5 6.5z"
        ></path>
        <path
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          className="fill-[#D988FF] dark:fill-[#ae00ff]"
          d="M16 13.5c0 4.142-2.502 4-6.645 4-4.142 0-8.355.142-8.355-4S6.858 7 11 7s5 2.358 5 6.5z"
        ></path>
        <path
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          className="fill-[#FFC188] dark:fill-[#b65800]"
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          className="fill-[#DDE4FF] dark:fill-[#0033ff]"
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <g clipPath="url(#prefix__clip0)">
          <path
            className="fill-[#D9FFC7] dark:fill-[#2c8c00]"
            d="M17 14.5c0 4.142-2.502 4-6.645 4-4.142 0-8.355.142-8.355-4S7.858 8 12 8s5 2.358 5 6.5z"
          ></path>
          <path
    ...
    >
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path
          className="fill-[#DDE4FF] dark:fill-[#1040ff]"
          d="M17 13.5c0 4.142-2.502 4-6.645 4-4.142 0-8.355.142-8.355-4S7.858 7 12 7s5 2.358 5 6.5z"
        ></path>
        <path
