const social = () => (
    <div className="flex flex:1  align-items:center  space-x-5 mx-5">
        ...
        ><svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <path d="M12.75 1.5h-7.5A3.75 3.75 0 001.5 5.25v7.5a3.75 3.75 0 003.75 3.75h7.5a3.75 3.75 0 003.75-3.75v-7.5a3.75 3.75 0 00-3.75-3.75z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M12 8.527a3 3 0 11-5.935.88A3 3 0 0112 8.528zM13.125 4.875h.008" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg
            ></a>
        ...
        ><svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <path d="M17.25 2.25a8.174 8.174 0 01-2.355 1.147A3.36 3.36 0 009 5.647v.75A7.995 7.995 0 012.25 3s-3 6.75 3.75 9.75a8.73 8.73 0 01-5.25 1.5c6.75 3.75 15 0 15-8.625 0-.209-.02-.417-.06-.622a5.79 5.79 0 001.56-2.753v0z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg
            ></a>
        ...
        ><svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <path d="M16.5 4.5L9 9.75 1.5 4.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg
            ></a>
    </div>
)
