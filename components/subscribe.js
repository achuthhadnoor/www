const subscribe = ()=>(
<div class="mx-auto px-5 rounded bg-white py-2 sm:flex sm rounded-xl">
    ...
    <form class="flex bg-green-50 rounded-xl p-2 my-2 sm:flex-1 justify-items-center items-center " onSubmit={(e)=>{e.preventDefault()}}>
