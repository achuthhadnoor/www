...
const Share = () => (
    ...
    >
        <path
            d="M18 13.5C18 17.6421 15.4976 17.5 11.3554 17.5C7.2133 17.5 3 17.6421 3 13.5C3 9.35786 8.85786 7 13 7C17.1421 7 18 9.35786 18 13.5Z"
            fill="#FFDDE3"
        />
        <path
...
const Icons = ({ name, other_props }: IProps) => {
    switch (name) {
        case 'Twitter':
            return <Twitter />
        case "Instagram":
