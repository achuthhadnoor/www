        ...
        <Container>
            ...
            <div className="container grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="bg-white p-4 m-2 rounded hover:transition hover:shadow-lg hover:duration-500 ease-in-out">
                    ...
                    <p className="p-1">Webcam companion for your native screen recorder and also to preview your zoom calls 🤭</p>
                </div>
                <div className="bg-white p-4 m-2 rounded hover:transition hover:shadow-lg hover:duration-500 ease-in-out">
                    <img src="/images/pages/apps/today.png" />
                    <div className="flex items-center my-2">
                    ...
                    <p className="p-1">A simple notes app on menubar to jot down your thoughts 💭</p>
                </div>
                <div className="bg-white p-4 m-2 rounded hover:transition hover:shadow-lg hover:duration-500 ease-in-out">
                    <img src="/images/pages/apps/snipcode.png" />
                    <div className="flex items-center my-2">
