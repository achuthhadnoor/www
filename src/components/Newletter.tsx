  ...
  return (
    <div className="mx-auto my-5 p-2 sm:p-8 max-w-2xl space-y-4 border-t border-b border-gray-300 border-dashed dark:border-gray-700 bg-elevated bg-gray-100 dark:bg-gray-800 dark:text-gray-200">
      <div className="space-y-2 ">
        ...
        <p className="text-tertiary text-sm dark:text-gray-300 leading-relaxed">
          ...
          <a
            ...
            className="ml-1 px-2 font-normal rounded-sm p-0.5 -mx-0.5 bg-blue-500 text-primary bg-opacity-20 hover:bg-opacity-30 dark:hover:bg-opacity-100 dark:text-gray-200"
          >
